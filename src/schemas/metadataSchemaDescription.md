# iSamples Metadata Guide

Here you will find proposed guidelines for standardizing sample metadata to describe interdisciplinary samples within the iSamples Community.

We seek any additional feedback, please add issues in the GitHub issue tracker.

Thanks to ESS-DIVE project for this markdown document layout.
...
### sampleIdentifier
|iSamples Element|<div align="right">sampleIdentifier <img width=200/> <code>Recommended</code> </div>|
|:------------------------|:----------------------------------------------------|
|**Definition**           |Globally unique and persistent identifier for the sample, e.g. IGSN, ARK. <br> Should be a resolvable URI.|
|**Format**               |alphanumeric characters |
|**Additional Instructions**||
|**Examples**             |https://igsn.org/IEWER7214, IEMEG0215                                 |


### Sample Name
|iSamples Element|<div align="right">sampleName <img width=200/> <code>Required</code> </div>|
|:------------------------|:----------------------------------------------------|
...
### Other names 
|iSamples Element|<div align="right">otherName <img width=200/> <code>Optional</code> </div>|
|:------------------------|:----------------------------------------------------|
...
### Specimen Type
|iSamples Proposed Element|<div align="right">specimenType <img width=200/> <code>Required</code> </div>| 
|:------------------------|:----------------------------------------------------|
|**Definition**           |Broad characterization of the nature of a sample or specimen.|
|**Format**               |See [specimen type list](terms/objectType.md) for terms proposed for iSamples|
|**Additional Instructions**|Provide feedback on additional terms or revisions needed.
|**Examples**             |Core; Individual Sample; Organism|

### MaterialType
|Proposed iSamples Element|<div align="right">materialType <img width=200/> <code>Required</code> </div>|
|:------------------------|:----------------------------------------------------|
...
### SampledFeatureType
|Proposed iSamples Element|<div align="right">sampledFeatureType <img width=200/> <code>Required</code> </div>|
|:------------------------|:----------------------------------------------------|
|**Definition**           |Material that the sample consists of.                |
|**Format**               |[SESAR controlled list.](https://app.geosamples.org/reference/materials.php)See ESS-DIVE's proposed [material terms](terms/material.md) from Environment<br> Ontology (ENVO)|
|**Additional Instructions**|Use a semi-colon to delimit multiple materials where needed. Please provide feedback<br> on any other terms needed.|
